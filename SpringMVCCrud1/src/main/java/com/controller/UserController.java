...
public class UserController {
	...
	@RequestMapping(value={ "/SpringMVCCrud1/register" }, method=RequestMethod.GET)
	public ModelAndView RegisterUser(){
		ModelAndView model;
		model = new ModelAndView("register");
		return model;
	}
	/*@RequestMapping(value={"/SpringMVCCrud1/registerprocess"}, method=RequestMethod.POST)
	...
	@RequestMapping(value={ "/SpringMVCCrud1/login" }, method=RequestMethod.GET)
	public ModelAndView LoginUser(){
		ModelAndView model;
		model = new ModelAndView("login");
		return model;
	}
	/*@RequestMapping(value="/SpringMVCCrud1/loginprocess", method=RequestMethod.POST)
	...
	@RequestMapping(value={ "/SpringMVCCrud1/welcome" }, method=RequestMethod.GET)
